    ...
    <main className="flex h-screen overflow-hidden flex-col items-center p-10">
      ...
      <div className="w-full grid grid-cols-3">
        ...
        <div className="flex justify-end">
          <button type="button"
                  className="flex items-center gap-2 bg-white rounded-full px-8 py-4 text-neutral-600 border border-neutral-400">
            <svg viewBox="0 -960 960 960" className="w-6 inline">
              <path
          ...
          <div className="col-span-2 col-start-2 row-start-1 flex justify-center">
            <div className="flex gap-16 pt-6">
              ...
              <div className="flex flex-col items-center gap-4">
                <button type="button" className="w-64 h-[4.5rem] bg-opov text-white font-medium text-xl rounded-full">
              ...
              <div className="flex flex-col items-center gap-4">
                <button type="button"
                        className="flex gap-2 items-center justify-center w-64 h-[4.5rem] bg-white border-2 border-green-500 font-medium text-xl rounded-full">
